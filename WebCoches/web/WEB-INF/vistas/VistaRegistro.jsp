            ...
            <div class="col">
                <form name="formRegistro" method="POST" action="${pageContext.request.contextPath}/sesion/registrar" >
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="mb-3">
                                <label for="formGrupoRegistro" class="formularioLabel">Contaseña:</label>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="mb-3">
                                <label for="formGrupoRegistro" class="formularioLabel">Correo Electrónico:</label>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="mb-3">
                                <label for="formGrupoRegistro" class="formularioLabel">Teléfono</label>
                                <input type="text" class="formularioInput" name="telefono" id="telefono" placeholder="Teléfono de Contacto" maxlength="9">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                            <div class="mb-4">
                                <label for="formGrupoRegistro" class="formularioLabel">Dirección</label>
                                <input type="text" class="formularioInput" name="direccion" id="direccion" placeholder="Dirección">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-2">
                            <div class="mb-3">
                                <label for="formGrupoRegistro" class="formularioLabel">Código Postal:</label>
                                <input type="text" class="formularioInput" name="cp" id="cp" placeholder="Dirección Postal">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="mb-3">
