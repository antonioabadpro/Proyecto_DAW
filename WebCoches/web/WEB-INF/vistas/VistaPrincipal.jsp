...
<div class="contenido">
    ...
    <div class="container-fluid p-0">
        <div class="row g-0 altura-fija-hero">
            <div class="col-md-6 columna-sin-padding">
                <div id="carouselImages" class="carousel slide anchoCarrusel carousel-fade" data-bs-ride="carousel">
            ...
            <div class="col-md-6 columna-sin-padding">
                <div id="carouselSlogans" class="carousel slide anchoCarrusel carousel-fade" data-bs-ride="carousel" data-bs-interval="4000">
                    <div class="carousel-inner w-100">
                        <div class="carousel-item active">
                            <div class="contenidoTextoCarrusel">
                                <div class="iconoSlogan">
                                    <i class="bi bi-shield-fill-check display-4 mb-3"></i>
                                </div>
                                <h2 class="tituloSlogan">Tu Compra, Garantía</h2>
                                <p class="textoSlogan">
                        ...
                        <div class="carousel-item">
                            <div class="contenidoTextoCarrusel">
                                <div class="iconoSlogan"><i class="bi bi-clock-history display-4 mb-3"></i></div>
                                <h2 class="tituloSlogan">Atención 24/7</h2>
                                <p class="textoSlogan">Estamos disponibles en todo momento.</p>
                            </div>
                        </div>

                        <div class="carousel-item">
                             <div class="contenidoTextoCarrusel">
                                <div class="iconoSlogan"><i class="bi bi-hand-thumbs-up-fill display-4 mb-3"></i></div>
                                <h2 class="tituloSlogan">Compra 100% Segura</h2>
                                <p class="textoSlogan">Tecnología de pago seguro.</p>
                            </div>
                        </div>
                    </div>
                </div>
