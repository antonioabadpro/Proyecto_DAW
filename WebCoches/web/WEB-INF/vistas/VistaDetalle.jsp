    ...
    <div class="detail-card  mx-auto my-4">
        <div class="row g-0">
            ...
            <div class="col-lg-6">
                <div id="carouselCoche" class="carousel slide carousel-container" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <c:if test="${empty requestScope.coche.foto1 and empty requestScope.coche.foto2}">
                            <div class="carousel-item active">
                                <img src="${pageContext.request.contextPath}/imagenes/silueta_coche.jpg" class="d-block w-100" alt="Sin imagen del Coche">
                            </div>
                        </c:if>
                    </div>
                ...
                <div class="ms-4">
                    <div class="elementoInformacion" style="height: auto; width: 100%; display: block;">
                        <div class="etiquetaInformacion text-center">
                            <i class="bi bi-file-text-fill"></i> Descripción
                        </div>
                        <div class="textoInformacion" style="font-size: 0.95rem; line-height: 1.5;">
                            <c:choose>
                                <c:when test="${empty requestScope.coche.descripcion}">
                                    No hay descripción detallada disponible para este vehículo.
                                </c:when>
                                <c:otherwise>
                                    ${requestScope.coche.descripcion}
                                </c:otherwise>
                            </c:choose>
                        </div>
                    </div>
