                ...
                <div class="mb-5">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="formularioInput w-auto" id="color" 
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="formularioInput" id="descripcion" name="descripcion" 
                ...
                <div class="mb-5">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="formularioInput w-auto" id="consumo" 
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="formularioInput w-auto" id="cv" 
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="formularioSelect w-auto" id="cambio" name="cambio" required>
                                <option value="">Seleccione</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="formularioInput w-auto" id="kilometros" 
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="formularioSelect w-auto" id="año" name="año" required>
                                <option value="">Seleccione</option>
                ...
                <div class="mb-5">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="formularioInput w-25" id="precio" 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="formularioInput w-25" id="descuento" 
                    ...
                    <div class="subirImagenSection">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 SubirImagenItem">
                                <label for="imagen1" class="formularioLabel">
                                    <i class="bi bi-image"></i> Imagen 1 (Principal)
                                </label>
                                <input type="file" class="formularioInput" id="imagen1" 
                                       name="imagen1" accept="image/*">
                            </div>

                            <div class="col-md-6 SubirImagenItem">
                                <label for="imagen2" class="formularioLabel">
                                    <i class="bi bi-image"></i> Imagen 2
                                </label>
                                <input type="file" class="formularioInput" id="imagen2" 
